    ...
    <div className='bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg overflow-hidden'>
      ...
      <form onSubmit={e => { void handleAdd(e) }} className='flex gap-2 px-4 py-3 border-t border-zinc-100 dark:border-zinc-800'>
        <input
          ...
          className='flex-1 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl px-3 py-2 text-sm text-zinc-900 dark:text-white placeholder-zinc-400 min-h-[40px] focus:outline-none focus:ring-2 focus:ring-primary'
        />
        <button
          type='submit'
          disabled={adding || !newName.trim()}
          className='bg-primary text-white rounded-xl px-4 py-2 text-sm font-medium min-h-[40px] disabled:opacity-50'
        >
          Add
        </button>
      </form>
